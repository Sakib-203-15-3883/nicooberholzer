...
const RenderInspectionShit = () => {
  ...
  return (
    <View style={styles.container}>
      <View>
        <Text style={styles.sectionTitle}>Running Sheet</Text>
        <FlatList
          data={runningSheet}
      ...
      <View>
        <Text style={styles.sectionTitle}>Past Sheet</Text>
        <FlatList
          data={pastSheet}
...
export default RenderInspectionShit;
